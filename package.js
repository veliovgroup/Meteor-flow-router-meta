...
Package.onUse((api) => {
  ...
  api.use(['ecmascript', 'ostrio:flow-router-title@3.5.3'], 'client');
...
Package.onTest((api) => {
  api.use(['tinytest', 'ecmascript', 'jquery', 'random', 'ostrio:flow-router-extra@3.15.3', 'ostrio:flow-router-title@3.5.3'], 'client');
