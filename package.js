...
Package.onUse((api) => {
  ...
  api.use(['ecmascript', 'ostrio:flow-router-title@3.4.1'], 'client');
  api.mainModule('flow-router-meta.js', 'client');
});

Package.onTest((api) => {
  api.use(['tinytest', 'ecmascript', 'jquery', 'random', 'ostrio:flow-router-extra@3.12.1', 'ostrio:flow-router-title@3.4.1'], 'client');
